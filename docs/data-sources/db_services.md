...
- `parameter_profile_id` (String)
- `script_info` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--databases--database_configuration--oracle_config--script_info))
- `username` (String)

<a id="nestedobjatt--db_services--databases--database_configuration--oracle_config--script_info"></a>
### Nested Schema for `db_services.databases.database_configuration.oracle_config.script_info`

Read-Only:

- `post_script_info` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--databases--database_configuration--oracle_config--script_info--post_script_info))

<a id="nestedobjatt--db_services--databases--database_configuration--oracle_config--script_info--post_script_info"></a>
### Nested Schema for `db_services.databases.database_configuration.oracle_config.script_info.post_script_info`
...
<a id="nestedobjatt--db_services--engine_configuration--collation_config"></a>
### Nested Schema for `db_services.engine_configuration.collation_config`
...
- `options_profile` (String)
- `parameter_profile_id` (String)
- `pdb_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--engine_configuration--oracle_config--pdb_config))
- `sid` (String)

<a id="nestedobjatt--db_services--engine_configuration--oracle_config--pdb_config"></a>
### Nested Schema for `db_services.engine_configuration.oracle_config.pdb_config`
...
- `archive_storage_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--infrastructure--archive_storage_config))
...
- `region` (String)
- `storage` (Number)
- `storage_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--infrastructure--storage_config))
- `storage_provider` (String)
- `throughput` (Number)
- `timezone` (String)
- `vpc` (String)

<a id="nestedobjatt--db_services--infrastructure--archive_storage_config"></a>
### Nested Schema for `db_services.infrastructure.archive_storage_config`

Read-Only:

- `azure_net_app_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--infrastructure--archive_storage_config--azure_net_app_config))
- `provider` (String)
...
<a id="nestedobjatt--db_services--infrastructure--storage_config"></a>
### Nested Schema for `db_services.infrastructure.storage_config`

Read-Only:

- `azure_net_app_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--infrastructure--storage_config--azure_net_app_config))
- `provider` (String)
...
- `archive_storage_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--instances--archive_storage_config))
- `availability_zone` (String)
- `aws_infra_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--instances--aws_infra_config))
- `cloud` (String)
- `compute_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--instances--compute_config))
- `compute_id` (String)
- `compute_name` (String)
- `compute_type` (String)
- `connect_string` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--instances--connect_string))
- `context_info` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--instances--context_info))
...
- `region` (String)
- `role` (String)
- `security_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--instances--security_config))
- `software_image` (String)
- `software_image_version` (String)
- `status` (String)
- `storage` (Number)
...
<a id="nestedobjatt--db_services--instances--archive_storage_config"></a>
### Nested Schema for `db_services.instances.archive_storage_config`
...
<a id="nestedobjatt--db_services--instances--compute_config"></a>
### Nested Schema for `db_services.instances.compute_config`

Read-Only:

- `exadata_config` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--instances--compute_config--exadata_config))
- `provider` (String)
...
<a id="nestedobjatt--db_services--instances--context_info"></a>
### Nested Schema for `db_services.instances.context_info`
...
<a id="nestedobjatt--db_services--instances--security_config"></a>
### Nested Schema for `db_services.instances.security_config`

Read-Only:

- `security_profile` (List of Object) (see [below for nested schema](#nestedobjatt--db_services--instances--security_config--security_profile))

<a id="nestedobjatt--db_services--instances--security_config--security_profile"></a>
### Nested Schema for `db_services.instances.security_config.security_profile`
